    ...
    <div style={myStyle}>
      <div className="d-flex justify-content-center align-items-center" style={{ height: '100%' }} >
        <div style={{width:'600px',height:'350px', color:'white'}}>
          ...
          <button style={{ fontSize: '' }} className='btnheder2 me-3 mb-2'><BsDownload className='fs-5'></BsDownload> Download For Windows</button>
          <button style={{ fontSize: '' }} className='btnheder3'> Open Discord in Your Browser</button>
        </div>
      </div>
    </div>
  )
